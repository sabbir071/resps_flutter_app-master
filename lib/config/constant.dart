...
const String apiURL = "resps.wsfilter.com";   // http://103.145.112.178:8000/api/      or        https://resps.wsfilter.com/api/
const String visibility = "";
const String apiBase = "/api";
const String apiVersion = "";
const String imageUrl="https://resps.wsfilter.com/";           //http://ps.wsfilter.com/     or

// database key name
const String userToken = "current_user_token";
const String officerImage='assets/saida_khanom.png';
const String govtImage='assets/govt_logo.png';
const String manImage='assets/man.png';
const String district='assets/district.png';
const String sub_district='assets/sub_district.png';

class CustomColors {
  static const primary = Color(0xFF558A2E);
